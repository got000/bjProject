                                ...
                                ?>
                                        <div class="row mb-3 shadow-sm mb-4">
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                ...
                                                <div class="row mb-3 p-3 text-center">
                                                    <div class="col-3"><p class="fw-bold">ปัญหา</p></div>
                                                    <div class="col-3"><p class="fw-bold">รายละเอียดปัญหา</p></div>
                                                    <div class="col-3"><p class="fw-bold">ราคา</p></div>
                                                    <div class="col-3"><p class="fw-bold">ส่วนลด</p></div>
                                                </div>
                                                <hr>
                                                <?php
                                    ...
                                    <div class="row mb-3 shadow-sm mb-4">
                                        <div class="col-12 text-center mt-5 mb-5">
                                            ...
                                            <p class="fs-3">ไม่มีประวัติการแจ้งปัญหา</p>
                                        </div>
                                    </div>
                                <?php } ?>
                            </div>
