                            ...
                            <table id="table_order" class="table table-striped table-hover text-center mt-2">
                                ...
                                <tbody>
                                    ...
                                    if (!empty($start_date) && !empty($end_date)) {
                                        $whereCondition = "WHERE DATE(order_date) BETWEEN '".$start_date."' AND '".$end_date."'";
                                    } else {
                                        $whereCondition = "";
                                    }
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><button data-bs-toggle="modal" type="button" data-bs-target="#modalOrder<?php echo $row["id"] ?>" class="btn btn-secondary btn-sm">รายการติดตั้ง</button></td>
                                                <td>
                                                    <?php if ($row["eq_status"] == 1) { ?>
                                                        <span class="badge bg-warning text-dark">รอติดตั้ง</span>
                                                    <?php } else if ($row["eq_status"] == 2) { ?>
                                        ...
                                        <tr>
                                            <td colspan="6">ไม่มีรายงานการติดตั้ง</td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
