...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($query) {
        ...
        header("location: cancelProblem_approve.php");
        exit;
    }
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-striped table-hover text-center mt-2">
                                ...
                                WHERE orders.cus_id = customers.cus_id AND orders.order_status = 9  AND orders.order_type = 2";
                                $query = mysqli_query($con, $sql);
                                $i = 0;
                                if ($query->num_rows > 0) {
                                ...
                                ?>
                                        ...
                                        <tr>
                                            <td colspan="8">ไม่มีข้อมูลรายการรอยกเลิก</td>
                                        </tr>
                                    <?php } ?>
                                        </tbody>
                            </table>
